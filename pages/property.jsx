...
const property = () => {
  return (
    <>
      <div>
        <Head>
          <title>Faisal | Create About Page</title>
      ...
      <div className="w-full">
        ...
        <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
          <div className="col-span-4">
            ...
            <button className="px-8 py-2 mt-4 mr-8 bg-gradient-to-r from-[#5651e5] to-[#709dff] text-white shadow-lg shadow-gray-400 rounded-md">
              Demo
            </button>
            <button className="px-8 py-2 mt-4 bg-gradient-to-r from-[#5651e5] to-[#709dff] text-white shadow-lg shadow-gray-400 rounded-md">
              Code
            </button>
          </div>

...
const About = () => {
  return (
    <div id='about' className='w-full sm:h-screen'>
      <div className="max-w-[1240px] mx-auto sm:grid grid-cols-3 gap-8">
<div className="col-span-2">
<p className='uppercase text-xl tracking-widest text-[#5651e5]'>About</p>
          <h2 className='py-2'>Who I Am</h2>
          <p className='py-1 text-gray-600'> {`// `}I am not your normal developer</p>
          <p className='py-2 text-gray-600'>
            I have spent the last 2.5 years in the fire service working as a
...
<div className='w-full h-auto m-auto shadow-xl shadow-gray-400 rounded-xl flex items-center justify-center p-4 hover:scale-105 ease-in duration-300'>
            <img className='rounded-xl' src="https://images.unsplash.com/photo-1568908952073-b20725d951d3?ixlib=rb-1.2.1&raw_url=true&q=80&fm=jpg&crop=entropy&cs=tinysrgb&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=867" alt="/" />
        </div>
